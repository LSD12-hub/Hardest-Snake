...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void draw(Graphics g){
        ...
        if(paused){
            ...
            g.drawString("Press P to Unpause", (SCREEN_WIDTH - metrics.stringWidth("Press P to Unpause")) / 2, SCREEN_HEIGHT / 2);
        }
    ...
    public class MyKeyAdapter extends KeyAdapter{
        ...
        public void keyPressed(KeyEvent e){
            ...
            if(e.getKeyCode() == 'P' && paused == false){
                paused = true;
                repaint();
                timer.stop();
            }else if(e.getKeyCode() == 'P' && paused == true){
                paused = false;
                repaint();
                timer.start();
            }
